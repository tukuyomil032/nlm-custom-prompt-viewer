...
const en: Dict = {
  ...
  "prompt.artifact.unsupported": "Unsupported in MVP",
  ...
  "prompt.list.help":
    "List prompts from artifacts.\n\nExamples:\n  nlm prompt list <notebookId>\n  nlm prompt list --type slides --limit 5\n  nlm prompt list --json\n\nIf notebook listing fails in interactive mode, you can continue by entering notebookId manually.\nSuccessful extractions are shown in the table, and failed artifacts are summarized as warnings.",
  "prompt.get.help":
  ...
  "prompt.list.partialSummary": "Some artifacts could not be extracted and were skipped ({count}).",
  "prompt.list.partialMore": "...and more skipped artifacts.",
...
const ja: Dict = {
  ...
  "prompt.artifact.unsupported": "MVP未対応",
  "prompt.artifact.supported": "対応",
  "prompt.artifact.unsupportedWarning":
    "可視化のため全成果物を表示していますが、未対応タイプは抽出対象外です。",
  "prompt.list.title": "NotebookLM Prompt List",
  "prompt.list.help":
    "成果物からプロンプト一覧を取得します。\n\n例:\n  nlm prompt list <notebookId>\n  nlm prompt list --type slides --limit 5\n  nlm prompt list --json\n\n対話モードでノート一覧取得に失敗した場合は、notebookId手入力で続行できます。\n抽出成功分は表で表示し、失敗分は警告として要約表示します。",
  "prompt.get.help":
  ...
  "prompt.list.partialSummary": "抽出できなかった成果物があり、スキップしました（{count}件）。",
  "prompt.list.partialMore": "…ほかにもスキップされた成果物があります。",
